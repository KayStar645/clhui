...
public class AlgoCLHMiner {
	...
	public void runAlgorithm(int minUtil, String inputPath, String outputPath, String TaxonomyPath) throws IOException {
		...
		//// ======================================================================
		//// =============================== Check tuList =====================================
		//printUtilityList(listOfUtilityLists);

	}

	public void printUtilityList(List<UtilityList> listOfUtilityLists) {
		for(UtilityList util : listOfUtilityLists) {
			printUtilityList(util);
		}
	}

	public void printUtilityList(UtilityList UtilityList) {
	...
	public String decryption(Integer data) {
		...
		for (int i = 0; i < da.length(); i++) {
			name += decryption2(Integer.parseInt(String.valueOf(da.charAt(i))));
		}
		return name;
	}

	public String decryption2(Integer data) {
		switch(data) {
			case 1:
				return "a";
			case 2:
